...
Этот проект позволяет уменьшить время разметки разломов, которое до этого происходило в основном каждым вручную. 


*Несколько предложений про смысл и ценность проекта для бизнеса (науки, человечества).
